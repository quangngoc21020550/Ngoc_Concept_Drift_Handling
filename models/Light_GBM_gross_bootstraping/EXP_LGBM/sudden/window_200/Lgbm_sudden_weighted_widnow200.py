...
sudden_df.to_csv(LOCAL_ABSOLUTE_PATH + 'models/Light_GBM_gross_bootstraping/EXP_LGBM/sudden/window_200/sudden_cd_weighted_cv8_window200.csv',index=False)
prediction_mean_df.to_csv(LOCAL_ABSOLUTE_PATH + 'models/Light_GBM_gross_bootstraping/EXP_LGBM/sudden/window_200/prediction_weighted_cv8_window200.csv',index=False)