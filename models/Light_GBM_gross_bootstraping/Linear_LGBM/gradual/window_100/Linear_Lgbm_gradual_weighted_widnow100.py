...
gradual_df.to_csv(LOCAL_ABSOLUTE_PATH + 'models/Light_GBM_gross_bootstraping/Linear_LGBM/gradual/window_100/Linear_gradual_cd_weighted_cv8_window100.csv',index=False)
prediction_mean_df.to_csv(LOCAL_ABSOLUTE_PATH + 'models/Light_GBM_gross_bootstraping/Linear_LGBM/gradual/window_100/Linear_gradual_prediction_weighted_cv8_window100.csv',index=False)