...
sudden_df.to_csv(LOCAL_ABSOLUTE_PATH + 'models/Light_GBM_gross_bootstraping/Linear_LGBM/sudden/window_100/Linear_sudden_cd_weighted_cv8_window100.csv',index=False)
prediction_mean_df.to_csv(LOCAL_ABSOLUTE_PATH + 'models/Light_GBM_gross_bootstraping/Linear_LGBM/sudden/window_100/Linear_Sudden_prediction_weighted_cv8_window100.csv',index=False)