...
gradual_df.to_csv(LOCAL_ABSOLUTE_PATH + 'models/Light_GBM_gross_bootstraping/Plain_LGBM/gradual/window_All/Plain_LGBM_gradual_cd_cv8_window_All.csv',index=False)
prediction_mean_df.to_csv(LOCAL_ABSOLUTE_PATH + 'models/Light_GBM_gross_bootstraping/Plain_LGBM/gradual/window_All/Plain_LGBM_gradual_prediction_cv8_window_All.csv',index=False)