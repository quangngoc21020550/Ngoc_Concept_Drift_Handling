...
sudden_df.to_csv(LOCAL_ABSOLUTE_PATH + 'models/Light_GBM_gross_bootstraping/Plain_LGBM/sudden/window_After/Plain_LGBM_sudden_cd_cv8_window_After.csv', index=False)